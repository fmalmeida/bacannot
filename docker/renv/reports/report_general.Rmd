...
In bacannot, the prokka database is incremented with either TIGRFAM's hmm [hosted at NCBI](https://ftp.ncbi.nlm.nih.gov/hmm/TIGRFAMs/release_15.0/) or with the extensive PGAP hmm database [hosted at NCBI](https://ftp.ncbi.nlm.nih.gov/hmm/3.0/) with the parameter `--prokka_use_pgap` is used.
```
