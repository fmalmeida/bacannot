...
if (class(custom_blast) == "try-error" ||
  ...
  blast_gff$`Custom DB Acc` <- getAttributeField(blast_gff$Attributes, paste(db_name, "_Acc", sep=""), ";")
  blast_gff$`Custom DB Target` <- getAttributeField(blast_gff$Attributes, paste(db_name, "_Target", sep=""), ";")
  blast_gff$`Custom DB Product` <- getAttributeField(blast_gff$Attributes, paste(db_name, "_Product", sep=""), ";")
