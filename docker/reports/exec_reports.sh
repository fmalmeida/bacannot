...
Rscript -e 'rmarkdown::render("report_resistance.Rmd", 
  params = list(
                  blast_id = 90 ,
                  blast_cov = 90,
                  ...
                  resfinder_phenotype = "/Volumes/falmeida1TB/bacannot_teste/output/KpV3/resistance/resfinder/args_pheno_table.txt",
...
Rscript -e 'rmarkdown::render("report_MGEs.Rmd", 
  params = list( blast_id = 65, 
                 ...
                 query = "KpV3",
                 gi_image = "/Volumes/falmeida1TB/bacannot_teste/output/KpV3/genomic_islands/plots/product_label/contig_1_segment0_GI_1.png",
                 gff = "/Volumes/falmeida1TB/bacannot_teste/output/KpV3/gffs/KpV3.gff", 
