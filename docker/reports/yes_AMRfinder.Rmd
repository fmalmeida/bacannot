The AMRFinderPlus annotation results are summarized below in an interactive table containing the complete annotation information (Table \@ref(tab:ncbi-amr-resistance-genes)) and image showing the targeted drug classes (Figure \@ref(fig:ncbi-resistome-png)). Whenever possible, all feature have links to NCBI database marking the closest reference sequence to each annotated gene. The results obtained with AMRFinderPlus can be roughly divided into two main categories: 
