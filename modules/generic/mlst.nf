process MLST {
   ...
   output:
   tuple val(prefix), path("${prefix}_mlst_analysis.txt")   optional true, emit: results
   tuple val(prefix), path("${prefix}_novel_alleles.fasta") optional true, emit: alleles
